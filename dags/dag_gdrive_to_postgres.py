...
def _process_csv(ti):
    ...
    # pull xcom
    dataset_files = ti.xcom_pull(key="dataset_files", task_ids="check_file_if_exists")
...
with DAG(
    dag_id='dag_transfer_gdrive_to_postgresql',
    ...
    check_file_if_exists=PythonOperator(
    ...
    start_task >> check_file_if_exists >> [process_csv, end_task]
